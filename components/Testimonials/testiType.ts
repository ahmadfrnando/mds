...
export const TestimonialData: Testimonial[] = [
  ...
  },
  {
    id: 2,
    name: "Budi",
    text: "Saya sangat senang dengan layanan yang diberikan. Customer service-nya sangat responsif dan membantu saya memilih desain yang tepat. Pengalaman bekerja sama yang sangat menyenangkan!",
  ...
  },
  {
    id: 7,
    name: "Rina",
    text: "Website yang dibuat sangat sesuai dengan deskripsinya. Kualitasnya sangat baik dan saya sangat puas dengan hasil ini. Pelayanannya juga sangat ramah dan cepat!",
